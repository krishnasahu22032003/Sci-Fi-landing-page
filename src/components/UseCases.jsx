    ...
    <section id="simulation" className="relative py-28 bg-black overflow-hidden">
      ...
      <div className="relative z-10 container mx-auto px-4 md:px-10">
        ...
        <div className="mb-16 text-center usecase-card">
          <h2 className="text-4xl md:text-5xl font-bold special-font text-[--color-blue-50] drop-shadow-[0_0_10px_rgba(100,149,255,0.25)] usecase-text">
            Real-World Applications
          </h2>
          <p className="mt-4 max-w-2xl mx-auto text-lg text-[--color-blue-50]/70 usecase-text">
        ...
        <div className="mt-16 usecase-card">
          <div className="usecase-text relative rounded-2xl overflow-hidden bg-gradient-to-br from-[--color-violet-400]/30 via-[--color-blue-500]/20 to-[#0d0d1c] p-10 shadow-xl backdrop-blur-sm border border-[--color-violet-500]/40">
